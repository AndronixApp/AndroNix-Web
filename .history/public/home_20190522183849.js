...
document.getElementById('red').addEventListener('click', adder);
document.getElementById('orange').addEventListener('click', adder);
document.getElementById('purple').addEventListener('click', adder);
document.getElementById('black').addEventListener('click', adder);
document.getElementById('gree').addEventListener('click', adder);
