...
function renderCafe(doc) {
  ...
  var animation = bodymovin.loadAnimation({
    ...
    path: 'https://assets2.lottiefiles.com/datafiles/vhvOcuUkH41HdrL/data.json', // Required
  ...
  var animation = lottie.loadAnimation({
    container: document.getAnimations('ani'), // the dom element that will contain the animation
    renderer: 'svg',
    loop: true,
    autoplay: true,
    path: 'https://assets2.lottiefiles.com/datafiles/vhvOcuUkH41HdrL/data.json' // the path to the animation json
  });
