...
window.onload = function () {
  document.getElementById("visibler").addEventListener("click", visibler);
...
$(document).ready(function(){
  $('.visibler').live('click', function() {
      $('#').fadeIn(1000);
      $('#comSeldesSel').fadeOut(1000);
  });
...
function visibler() {
  ...
  console.log("Reaching visibler");
  if (!io) {
    document.getElementById("colorSel").style.display = "block";
    document.getElementById("comSel").style.display = "block";
    document.getElementById("desSel").style.display = "block";
    document.getElementById("adder").style.display = "block";
    io = true;
  }
  else {
    document.getElementById("colorSel").style.display = "none";
    document.getElementById("comSel").style.display = "none";
    document.getElementById("desSel").style.display = "none";
